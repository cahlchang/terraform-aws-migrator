...
class CollectionStatus:
    ...
    def update_service(self, service_name: str, status: str, resource_count: Optional[int] = None):
    ...
    def get_table(self) -> Table:
        ...
        for service, info in self.services_status.items():
            ...
            resource_count = str(info['resource_count']) if info['resource_count'] is not None else "-"
